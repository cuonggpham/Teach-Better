...
class PostService:
    ...
    async def count_posts(
        ...
        """
        # Always use simple query for now (aggregation can be slow/buggy)
        # TODO: Re-enable aggregation search for author/tag names after optimization
        if False:  # Disabled aggregation search
            pass
        else:
